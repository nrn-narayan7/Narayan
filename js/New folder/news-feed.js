    ...
    articleElement.innerHTML = `
        ...
        <div class="article-content">
            ...
            <div class="article-source">
                ...
                <button class="read-more-btn" data-url="${article.url}" data-demo="true">Read Full Article</button>
            </div>
        </div>
    `;
    ...
    if (readMoreBtn) {
        readMoreBtn.addEventListener('click', function(e) {
            ...
            try {
                ...
                const isDemo = this.getAttribute('data-demo') === 'true';
                
                if (isDemo && url.includes('example.com')) {
                    // Show demo notification instead of opening example.com
                    showNotification('info', 'Demo Mode', 'This is a demo article. In a real implementation, this would open the actual article page.');
                    
                    // Create a modal to show article details
...
function getNewsArticles() {
    ...
    return [
        ...
        },
        {
            ...
            url: "https://example.com/nepal-precision-farming-app",
        ...
        },
        {
            ...
            url: "https://example.com/quantum-geospatial",
        ...
        },
        {
            ...
            url: "https://example.com/ar-field-data",
